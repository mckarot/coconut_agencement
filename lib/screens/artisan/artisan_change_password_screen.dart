...
class ArtisanChangePasswordScreen extends StatefulWidget {
  const ArtisanChangePasswordScreen({super.key});

  @override
  State<ArtisanChangePasswordScreen> createState() => _ArtisanChangePasswordScreenState();
}

class _ArtisanChangePasswordScreenState extends State<ArtisanChangePasswordScreen> {
